            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, []];
                    case 4: return [4 /*yield*/, client.listMessages(inCallOptions.mailbox, "1:*", // get all messages from first onwards
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, "" + parsed.text]; // added "" because parsed.text might be undefined
                }
            });
        });
    }; /* End getMessageBody(). */
