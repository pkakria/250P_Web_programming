            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, axios_1.default.get(config_1.config.serverAddress + "/contacts")];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, axios_1.default.post(config_1.config.serverAddress + "/contacts", inContact)];
                    case 1:
                        response = _a.sent();
                        return [2, response.data];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, axios_1.default.delete(config_1.config.serverAddress + "/contacts/" + inID)];
                    case 1:
                        _a.sent();
                        return [2];
                }
